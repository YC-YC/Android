 ...
 * TODO:
 */
public class EnvelopeViewOld extends View {
	...
	public EnvelopeViewOld(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		getStyleAttributes(attrs);
		init();
	}

	public EnvelopeViewOld(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public EnvelopeViewOld(Context context) {
		this(context, null);
	}
...
//				mRadio, persent, mDegreed, mNumber, mFromColor, mToColor, mRotateAngle));
	...
	private void init() {
		...
		mCenterPoint = new Point(mRadio, mRadio);
...
//			canvas.drawPath(path, pointPaint);
	...
	public void changePoints(int index, int d) {
		...
		int centerX = mRadio;
		int centerY = mRadio;
		int radio = mRadio -mViewLength + d;
