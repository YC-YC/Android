...
public class MainActivity4 extends Activity {
	...
	private EnvelopeView mBackView, mFrontView, mLeftView, mRightView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_envolop);
		mFrontView = (EnvelopeView) findViewById(R.id.envelope_front);
		mBackView = (EnvelopeView) findViewById(R.id.envelope_back);
		mLeftView = (EnvelopeView) findViewById(R.id.envelope_left);
		mRightView = (EnvelopeView) findViewById(R.id.envelope_right);
	...
	private class MyOnSeekBarChangeListener implements OnSeekBarChangeListener {
		...
		public void onProgressChanged(SeekBar seekBar, int progress,
			...
			case R.id.seekBar1:
				...
				break;
			case R.id.seekBar2:
				mFrontView.changePoints(2, progress-50);
				break;
			case R.id.seekBar3:
				mFrontView.changePoints(3, progress-50);
				break;
			case R.id.seekBar4:
				mFrontView.changePoints(4, progress-50);
				break;
			case R.id.seekBar5:
